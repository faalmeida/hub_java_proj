 ...
 *
 * To Run :
 * mvn compile exec:java -Dexec.mainClass="com.cloudera.example.ClouderaImpalaJdbcExample"
 */
public class ClouderaImpalaJdbcExample {
	
	// here is an example query based on one of the Hue Beeswax sample tables 
	private static final String SQL_STATEMENT = "SELECT * FROM t1";
	
	// set the impalad host
	private static final String IMPALAD_HOST = "quickstart";
	...
	public static final String IMPALA_CONNECTION_URL = "jdbc:impala://" + IMPALAD_HOST + ':' + IMPALAD_JDBC_PORT + "/default;auth=noSasl;"
			+ "UID=fabio;PWD=admin1;AuthMech=3;";
	...
	public static void main(String[] args) {
		...
		System.out.println("Using Connection URL: " + IMPALA_CONNECTION_URL);
