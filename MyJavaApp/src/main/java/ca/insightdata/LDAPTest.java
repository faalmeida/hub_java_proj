...
public class LDAPTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = "ldap://faa-centos-002.cloudera:389";
        final String ldapSearchBase = "dc=cloudera";
        
        final String ldapUsername = "ldapadm";
        final String ldapPassword = "almeida74";
        
        final String ldapAccountToLookup = "fabio";
    ...
    public SearchResult findAccountByAccountName(DirContext ctx, String ldapSearchBase, String accountName) throws NamingException {
        ...
        String searchFilter = "(&(objectClass=user)(uid=" + accountName + "))";
